...
void FourLineDisplayUsermod::appendConfigData() {
  oappend(F("dd=addDD('4LineDisplay','type');"));
  oappend(F("addO(dd,'None',0);"));
  oappend(F("addO(dd,'SSD1306',1);"));
  oappend(F("addO(dd,'SH1106',2);"));
  oappend(F("addO(dd,'SSD1306 128x64',3);"));
  oappend(F("addO(dd,'SSD1305',4);"));
  oappend(F("addO(dd,'SSD1305 128x64',5);"));
  oappend(F("addO(dd,'SSD1309 128x64',9);"));
  oappend(F("addO(dd,'SSD1306 SPI',6);"));
  oappend(F("addO(dd,'SSD1306 SPI 128x64',7);"));
  oappend(F("addO(dd,'SSD1309 SPI 128x64',8);"));
  oappend(F("addI('4LineDisplay:type',1,'<br><i class=\"warn\">Change may require reboot</i>','');"));
  oappend(F("addI('4LineDisplay:pin[]',0,'','SPI CS');"));
  oappend(F("addI('4LineDisplay:pin[]',1,'','SPI DC');"));
  oappend(F("addI('4LineDisplay:pin[]',2,'','SPI/I2C RST');"));
  oappend(F("addI('4LineDisplay:pin[]',3,'','Vext');"));
}
