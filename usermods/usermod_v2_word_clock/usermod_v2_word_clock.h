...
class WordClockUsermod : public Usermod 
{
  ...
  public:
    ...
    */
    ...
    {
      oappend(F("addI('WordClockUsermod:ledOffset', 1, 'Number of LEDs before the letters');"));
      oappend(F("addI('WordClockUsermod:Norddeutsch', 1, 'Viertel vor instead of Dreiviertel');"));
    }
