...
The LED strip is switched [using a relay](https://github.com/wled/WLED/wiki/Control-a-relay-with-WLED) to keep the power consumption low when it is switched off.
