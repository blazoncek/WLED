...
class Segment {
  ...
  private:
    ...
    static uint16_t      _lastPaletteChange;  // last random palette change time (in millis()/100)
    static uint16_t      _nextPaletteBlend;   // next due time for random palette morph (in millis()/100)
