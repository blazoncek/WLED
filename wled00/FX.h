...
class Segment {
  ...
  private:
    ...
    static uint16_t      _nextPaletteChange;  // last random palette change time in millis()/1000
    static uint16_t      _nextPaletteBlend;   // next due time for random palette morph (in millis()>>10)
