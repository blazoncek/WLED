...
const output = ["wled00/html_ui.h", "wled00/html_pixart.h", "wled00/html_pxforge.h", "wled00/html_cpal.h", "wled00/html_pxmagic.h", "wled00/html_settings.h", "wled00/html_other.h"]
...
function adoptVersionAndRepo(html) {
  ...
  if (repoUrl) {
    ...
    html = html.replaceAll("https://github.com/wled/WLED", repoUrl);
  }
